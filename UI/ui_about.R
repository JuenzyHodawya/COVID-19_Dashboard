      ...
      column(
        box(title = div("About this project", style = "padding-left: 20px", class = "h2"),
          column(
            ...
            "This COVID-19 Dashboard was build from Shiny packages and developed by Juenzy Hodawya (Student at Matana University). This App demonstrates some recent news about the Coronavirus pandemic. 
